...
def assess_diversification(portfolio_input: PortfolioInput):
    try:
        ...
        return {
            ...
            "mean_correlation_excluding_new_stock": mean_correlation_excluding_new_stock,
            "mean_correlation_including_new_stock": mean_correlation_including_new_stock,
...
def calculate_mean_correlation_excluding(correlation_matrix, new_stock):
    # Exclude the new stock from the correlation matrix
...
def calculate_mean_correlation_including(correlation_matrix, new_stock):
    # Include the new stock in the correlation matrix
